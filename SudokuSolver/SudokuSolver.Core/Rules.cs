...
namespace SudokuSolver.Core
{
    public class Rules
    {
        //public RuleResult InnerSquareEliminationRuleMethod1(SquareGroup group)
        //{
        //    int squaresSolved = 0;
        //    int i = 0;
        ...
        public RuleResult InnerSquareEliminationRule(int[,] gameBoard, HashSet<int>[,] gameBoardPossibilities)
        {
            int squaresSolved = 0;
