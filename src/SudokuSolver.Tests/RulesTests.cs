...
";
            ...
            Assert.AreEqual(2, gameState.GameBoardPossibilities[6, 3].Count);
            Assert.AreEqual(2, gameState.GameBoardPossibilities[7, 3].Count);
            Assert.AreEqual(2, gameState.GameBoardPossibilities[7, 4].Count);
